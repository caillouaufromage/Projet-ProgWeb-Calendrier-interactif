...
<h1><img src="images/logo_modifCours.png" width=50px height=50px>&nbsp;Modifier un cours&nbsp;<img src="images/logo_modifCours.png" width=50px height=50px></h1>
    <div>
        <form action="modifCoursEns.php" method="post">
            ...
            <label>Type de cours: <?php echo $coursAModifier['type']; ?></label><br>
            <label>Matière: <?php echo $coursAModifier['matiere']; ?></label><br>
            <label>Enseignant: <?php echo $coursAModifier['enseignant']; ?></label><br>
            <label>Salle: <?php echo $coursAModifier['salle']; ?></label><br>
            <label>Jour: <?php echo $coursAModifier['jour']; ?></label><br>
            ...
            echo $groupe_text; ?></label><br>

            <label>Date de début de semaine: <?php echo $coursAModifier['week_start']; ?></label><br>
